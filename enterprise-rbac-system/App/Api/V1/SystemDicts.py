...
def update_dict(
    ...
    try:
        current_user, tenant_id = current_user_with_tenant
        dict_service = SystemDictService(db)
        dict_obj = dict_service.update_dict(dict_id, dict_data, tenant_id=tenant_id, user_id=current_user.id)
...
def update_dict_item(
    ...
    try:
        current_user, tenant_id = current_user_with_tenant
        dict_service = SystemDictService(db)
        item = dict_service.update_dict_item(item_id, item_data, tenant_id=tenant_id, user_id=current_user.id)
