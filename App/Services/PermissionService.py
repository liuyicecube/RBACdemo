...
class PermissionService:
    ...
    def get_permission_by_id(self, permission_id: int, tenant_id: int) -> PermissionModel:
        """根据ID获取权限"""
    ...
    def get_permission_by_code(self, code: str, tenant_id: int) -> PermissionModel:
        """根据权限编码获取权限"""
    ...
    def get_permissions(self, tenant_id: int, skip: int = 0, limit: int = 100) -> List[PermissionModel]:
        """获取权限列表"""
    ...
    def get_permissions_by_type(self, permission_type: int, tenant_id: int, skip: int = 0, limit: int = 100) -> List[PermissionModel]:
        """根据权限类型获取权限列表"""
    ...
    def get_permissions_by_resource_type(self, resource_type: str, tenant_id: int, skip: int = 0, limit: int = 100) -> List[PermissionModel]:
        """根据资源类型获取权限列表"""
        return self.permission_repository.get_by_resource_type(resource_type, tenant_id=tenant_id, skip=skip, limit=limit)

    def get_permissions_by_parent_id(self, parent_id: int, tenant_id: int, skip: int = 0, limit: int = 100) -> List[PermissionModel]:
        """根据父权限ID获取子权限列表"""
        if parent_id != 0:
    ...
    def search_permissions(self, keyword: str, tenant_id: int, skip: int = 0, limit: int = 100) -> List[PermissionModel]:
        """搜索权限"""
    ...
    def create_permission(self, permission_data: Dict[str, Any], tenant_id: int, created_by: int) -> PermissionModel:
        """创建权限"""
    ...
    def update_permission(self, permission_id: int, permission_data: Dict[str, Any], tenant_id: int, updated_by: int) -> PermissionModel:
        """更新权限"""
        permission = self.permission_repository.get_by_id(permission_id, tenant_id=tenant_id)
        if not permission:
            raise NotFoundException(detail="权限不存在")
    ...
    def delete_permission(self, permission_id: int, tenant_id: int) -> bool:
        """删除权限"""
        permission = self.permission_repository.get_by_id(permission_id, tenant_id=tenant_id)
        if not permission:
            raise NotFoundException(detail="权限不存在")
    ...
    def update_permission_status(self, permission_id: int, status: int, tenant_id: int, updated_by: int) -> PermissionModel:
        """更新权限状态"""
    ...
    def get_permission_roles(self, permission_id: int, tenant_id: int) -> List[Dict[str, Any]]:
        """获取权限关联的角色列表"""
        permission = self.permission_repository.get_by_id(permission_id, tenant_id=tenant_id)
        if not permission:
            raise NotFoundException(detail="权限不存在")
    ...
    def count_permission_roles(self, permission_id: int, tenant_id: int) -> int:
        """统计权限关联的角色数量"""
        permission = self.permission_repository.get_by_id(permission_id, tenant_id=tenant_id)
        if not permission:
            raise NotFoundException(detail="权限不存在")
