...
class TreeUtils:
    ...
    @staticmethod
    def list_to_tree(data: List[Dict[str, Any]], id_key: str = "id", parent_id_key: str = "parent_id", children_key: str = "children") -> List[Dict[str, Any]]:
        """将列表转换为树形结构"""
        # 创建节点映射
    ...
    @staticmethod
    def get_tree_node_by_id(tree: List[Dict[str, Any]], node_id: Any, id_key: str = "id", children_key: str = "children") -> Optional[Dict[str, Any]]:
        """根据ID获取树形结构中的节点"""
        for node in tree:
    ...
    @staticmethod
    def get_tree_node_ancestors(tree: List[Dict[str, Any]], node_id: Any, id_key: str = "id", parent_id_key: str = "parent_id", children_key: str = "children") -> List[Dict[str, Any]]:
        """获取节点的所有祖先节点"""
        # 先将树形结构转换为节点映射
        node_map = {}
    ...
    @staticmethod
    def get_tree_node_descendants(tree: List[Dict[str, Any]], node_id: Any, id_key: str = "id", children_key: str = "children") -> List[Dict[str, Any]]:
        """获取节点的所有后代节点"""
        descendants = []
    ...
    @staticmethod
    def filter_tree(tree: List[Dict[str, Any]], filter_func: callable, children_key: str = "children") -> List[Dict[str, Any]]:
        """根据条件过滤树形结构"""
        filtered_tree = []
    ...
    @staticmethod
    def flatten_tree(tree: List[Dict[str, Any]], children_key: str = "children") -> List[Dict[str, Any]]:
        """将树形结构展平为列表"""
        flattened = []
    ...
    @staticmethod
    def build_tree(data: List[Dict[str, Any]], id_key: str = "id", parent_id_key: str = "parent_id", children_key: str = "children") -> List[Dict[str, Any]]:
        """构建树形结构"""
        return TreeUtils.list_to_tree(data, id_key, parent_id_key, children_key)
    
    @staticmethod
    def sort_tree(tree: List[Dict[str, Any]], sort_key: str = "sort", children_key: str = "children") -> List[Dict[str, Any]]:
        """根据指定键对树形结构进行排序"""
        # 先对当前层级的节点进行排序
