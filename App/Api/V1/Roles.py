...
@router.get("/all", response_model=AuthResponse, summary="获取所有启用的角色（用于下拉选择）", dependencies=[Depends(permission_dependency("role:view"))])
...
def assign_permissions(
    ...
    try:
        ...
        import traceback
        print(f"Error in assign_permissions: {e}")
        print(traceback.format_exc())
        return ResponseUtils.error(message=str(e), code=500, error_code=50000)
